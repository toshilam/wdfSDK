...
(function() {
	...
	var p = VOEvent.prototype = Object.create( wdf.ApplicationEvent.prototype);
	...
	p.clone = function() 
	{
		return new wdf.VOEvent(this.type, this.targetDisplayObject, this.data, this.propertyName, this.propertyValue);
	}
