...
( function() {
	...
	var Timer = function(inInterval, inCount) 
	{
		...
		{
			throw 'Timer : unable to initialize wdf.Timer!';
		}
	...
	p.start = function()
	{
		...
		wdf.Tracer.echo('Timer : start : fail : timer is running or no data is set!');
		return false;
	}
	
	p.stop = function()
	{
		//wdf.Tracer.echo('Timer : stop : ' + this._timerID);
